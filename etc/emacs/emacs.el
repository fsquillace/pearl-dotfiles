...
;;(setq pearl-path-settings (concat (getenv "PEARL_ROOT") "/mods/pearl/dotfiles/etc/emacs/emacs.d/settings"))
;;(setq pearl-path-plugins (concat (getenv "PEARL_ROOT") "/mods/pearl/dotfiles/etc/emacs/emacs.d/plugins"))
